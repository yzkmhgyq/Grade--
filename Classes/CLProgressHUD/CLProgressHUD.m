...
- (void)layout {
    ...
    if (_shape == CLProgressHUDShapeLinear) {
        ...
        self.stringLabel.frame = CGRectMake(xMargin, CGRectGetHeight(_hudView.bounds)-20, CGRectGetWidth(_hudView.bounds)-xMargin*2, 32);
    }
}
...
- (void)initSubviews {
    ...
    stringLabel.font = [UIFont systemFontOfSize:28.0f];
